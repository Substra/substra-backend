...
- BREAKING: Change the format of some error API responses from `{"detail": ...}` to `{"message": ...}`, to match the rest of the API ([#699](https://github.com/Substra/substra-backend/pull/699))
