...
| Name                                         | Description | Value |
| -------------------------------------------- | ----------- | ----- |
| `registryPrepopulate.waitRegistry.resources` |             | `{}`  |
| `registryPrepopulate.pause.resources`        |             | `{}`  |
