...
| `server.image.tag`                                | Substra backend server image tag                                                                                                                   | `0.30.0`                                   |
...
| `server.metrics.image.tag`                        | Substra backend server Prometheus Exporter image tag                                                                                               | `0.30.0`                                   |
...
| `worker.image.tag`                             | Substra backend worker image tag                                                                                                                   | `0.30.0`                  |
...
| `worker.events.image.tag`                      | Substra event app image tag                                                                                                                        | `0.30.0`                  |
...
| `schedulerWorker.image.tag`                     | Substra backend tasks scheduler image tag         | `0.30.0`                  |
...
| `scheduler.image.tag`                     | Substra backend tasks scheduler image tag         | `0.30.0`                  |
...
| `api.events.image.tag`                     | Substra event app image tag                         | `0.30.0`                  |
