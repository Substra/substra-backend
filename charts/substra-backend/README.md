...
| `server.image.tag`                                | Substra backend server image tag                                                                                                                   | `0.23.1`                          |
...
| `server.metrics.image.tag`                        | Substra backend server Prometheus Exporter image tag                                                                                               | `0.23.1`                          |
...
| `worker.image.tag`                             | Substra backend worker image tag                                                                                                                   | `0.23.1`                         |
...
| `schedulerWorker.image.tag`                     | Substra backend tasks scheduler image tag         | `0.23.1`                         |
...
| `scheduler.image.tag`                     | Substra backend tasks scheduler image tag         | `0.23.1`                         |
...
| `events.image.tag`                     | Substra event app image tag                         | `0.23.1`                         |
