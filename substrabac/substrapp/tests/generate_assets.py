...
def main():
    ...
    client.add_profile('owkin', 'substra', 'p@$swr0d44', 'http://substrabac.owkin.xyz:8000', '0.0')
    client.login()
    ...
    with open(assets_path, 'w') as f:
        ...
        for k, v in assets.items():
            v = v.replace('substrabac.owkin.xyz:8000', 'testserver')
            v = v.replace('substrabac.chunantes.xyz:8001', 'testserver')
