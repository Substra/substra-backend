...
class ChallengeViewTests(APITestCase):
    ...
    def test_challenge_create(self):
        ...
        data = {
            ...
            'test_dataset_key': '3412e10beb007a0841a5506c4ba2a451c4a19f762ba9c2db6fa096225759f07a'
        }
    ...
    def test_challenge_compute_dryrun(self):
        ...
        opener_path = os.path.join(dir_path, '../../fixtures/owkin/datasets/3412e10beb007a0841a5506c4ba2a451c4a19f762ba9c2db6fa096225759f07a/opener.py')
...
class AlgoViewTests(APITestCase):
    ...
    def test_algo_compute_dryrun(self):
        ...
        with open(opener_path, 'rb') as f:
            opener_content = f.read()
        opener_pkhash = '3412e10beb007a0841a5506c4ba2a451c4a19f762ba9c2db6fa096225759f07a'
...
class DatasetViewTests(APITestCase):
    ...
    def test_dataset_retrieve(self):
        url = reverse('substrapp:dataset-list')
        dataset_response = [d for d in dataset if d['key'] == 'ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98'][0]
        with mock.patch.object(DatasetViewSet, 'getObjectFromLedger') as mgetObjectFromLedger, \
            ...
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                   '../../fixtures/chunantes/datasets/ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/opener.py'), 'rb') as f:
                opener_content = f.read()

            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                   '../../fixtures/chunantes/datasets/ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/description.md'), 'rb') as f:
            ...
            search_params = 'ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/'
            response = self.client.get(url + search_params, **self.extra)
            r = response.json()
...
class DataViewTests(APITestCase):
    ...
    def test_data_create_bulk(self):
        ...
        data = {
            ...
            'dataset_keys': ['ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98'],
            'test_only': False
        }
    ...
    def test_data_compute_dryrun(self):
        ...
        opener_path = os.path.join(dir_path, '../../fixtures/chunantes/datasets/ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/opener.py')
