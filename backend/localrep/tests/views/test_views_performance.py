...
class CPPerformanceViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse("localrep:compute_plan_perf-list", args=[self.compute_plan.key])
...
class PerformanceViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.extra = {"HTTP_SUBSTRA_CHANNEL_NAME": "mychannel", "HTTP_ACCEPT": "application/json;version=0.0"}
        self.url = reverse("localrep:performance-list")
        self.export_extra = {"HTTP_SUBSTRA_CHANNEL_NAME": "mychannel", "HTTP_ACCEPT": "*/*"}
        self.export_url = reverse("localrep:performance-export")
