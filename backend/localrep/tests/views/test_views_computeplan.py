...
class ComputePlanViewTests(AuthenticatedAPITestCase):
    def setUp(self):
        ...
        self.url = reverse("localrep:compute_plan-list")
    ...
    def test_compute_plan_update(self):
        ...
        url = reverse("localrep:compute_plan-detail", args=[key])
    ...
    @mock.patch("localrep.views.computeplan.ComputePlanViewSet.create", side_effect=Exception("Unexpected error"))
    ...
    @internal_server_error_on_exception()
    @mock.patch("localrep.views.computeplan.ComputePlanViewSet.list", side_effect=Exception("Unexpected error"))
    ...
    def test_computeplan_retrieve(self):
        url = reverse("localrep:compute_plan-detail", args=[self.expected_results[0]["key"]])
        response = self.client.get(url, **self.extra)
        self.assertEqual(response.json(), self.expected_results[0])

    @internal_server_error_on_exception()
    @mock.patch("localrep.views.computeplan.ComputePlanViewSet.retrieve", side_effect=Exception("Unexpected error"))
    ...
    def test_computeplan_cancel(self):
        url = reverse("localrep:compute_plan-cancel", args=[self.expected_results[0]["key"]])
    ...
    @internal_server_error_on_exception()
    @mock.patch("localrep.views.computeplan.ComputePlanViewSet.cancel", side_effect=Exception("Unexpected error"))
