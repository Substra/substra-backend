...
from localrep.views.filters_utils import LogsPermissionFilter
...
def _register_in_orchestrator(request, instance):
    ...
    orc_dm = {
        ...
        "opener": {
            ...
            "storage_address": current_site + reverse("localrep:data_manager-opener", args=[instance.key]),
        },
        "type": request.data.get("type"),
        "description": {
            "checksum": get_hash(instance.description),
            "storage_address": current_site + reverse("localrep:data_manager-description", args=[instance.key]),
        },
        "new_permissions": {
