...
def convert_address(apps, schema_editor):
    metric_model = apps.get_model("localrep", "metric")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("localrep", "0010_taskdatasamples_remove_computetask_data_samples_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="metrics",
            field=models.ManyToManyField(related_name="test_tasks", to="localrep.algo"),
        ),
        migrations.AlterField(
            model_name="performance",
            name="metric",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, related_name="performances", to="localrep.algo"
            ),
        ),
