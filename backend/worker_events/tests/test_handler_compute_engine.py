...
def test_handle_task_outputs(mocker: MockerFixture):
    ...
    orc_client = mocker.Mock()
    m_schedule_task = mocker.patch("worker_events.handler_compute_engine.queue_disable_transient_outputs")
    handler_compute_engine._MY_ORGANIZATION = "my_worker"
...
def test_handle_finished_task(mocker: MockerFixture):
    ...
    m_handle_task_outputs = mocker.patch("worker_events.handler_compute_engine._handle_task_outputs")
