...
_DATAMANAGER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='objective_key', full_name='orchestrator.DataManager.objective_key', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='orchestrator.DataManager.description', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='opener', full_name='orchestrator.DataManager.opener', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='orchestrator.DataManager.type', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='creation_date', full_name='orchestrator.DataManager.creation_date', index=8,
...
_NEWDATAMANAGER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='objective_key', full_name='orchestrator.NewDataManager.objective_key', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='orchestrator.NewDataManager.description', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='opener', full_name='orchestrator.NewDataManager.opener', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='orchestrator.NewDataManager.type', index=6,
...
_DATAMANAGERUPDATEPARAM = _descriptor.Descriptor(
  name='DataManagerUpdateParam',
  full_name='orchestrator.DataManagerUpdateParam',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='orchestrator.DataManagerUpdateParam.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='objective_key', full_name='orchestrator.DataManagerUpdateParam.objective_key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATAMANAGERUPDATERESPONSE = _descriptor.Descriptor(
  name='DataManagerUpdateResponse',
  full_name='orchestrator.DataManagerUpdateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
DESCRIPTOR.message_types_by_name['DataManagerUpdateParam'] = _DATAMANAGERUPDATEPARAM
DESCRIPTOR.message_types_by_name['DataManagerUpdateResponse'] = _DATAMANAGERUPDATERESPONSE
...
DataManagerUpdateParam = _reflection.GeneratedProtocolMessageType('DataManagerUpdateParam', (_message.Message,), {
  'DESCRIPTOR' : _DATAMANAGERUPDATEPARAM,
  '__module__' : 'datamanager_pb2'
  # @@protoc_insertion_point(class_scope:orchestrator.DataManagerUpdateParam)
  })
_sym_db.RegisterMessage(DataManagerUpdateParam)

DataManagerUpdateResponse = _reflection.GeneratedProtocolMessageType('DataManagerUpdateResponse', (_message.Message,), {
  'DESCRIPTOR' : _DATAMANAGERUPDATERESPONSE,
  '__module__' : 'datamanager_pb2'
  # @@protoc_insertion_point(class_scope:orchestrator.DataManagerUpdateResponse)
  })
_sym_db.RegisterMessage(DataManagerUpdateResponse)
...
_DATAMANAGERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateDataManager',
    full_name='orchestrator.DataManagerService.UpdateDataManager',
    index=1,
    containing_service=None,
    input_type=_DATAMANAGERUPDATEPARAM,
    output_type=_DATAMANAGERUPDATERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
