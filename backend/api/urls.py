...
router.register(r"function", views.AlgoViewSet, basename="function")
router.register(r"function", views.AlgoPermissionViewSet, basename="function")
...
compute_plan_router.register(r"functions", views.CPAlgoViewSet, basename=f"{CP_BASENAME_PREFIX}function")
