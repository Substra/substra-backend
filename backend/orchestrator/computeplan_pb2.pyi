...
class _ComputePlanStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ComputePlanStatus.ValueType], builtins.type):
...
class QueryPlansParam(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        page_token: typing.Text = ...,
        page_size: builtins.int = ...,
        filter: typing.Optional[global___PlanQueryFilter] = ...,
        ) -> None: ...
...
class QueryPlansResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        plans: typing.Optional[typing.Iterable[global___ComputePlan]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
