...
class Event(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["asset", b"asset"]) -> typing_extensions.Literal["algo", "compute_plan", "compute_task", "data_manager", "data_sample", "failure_report", "model", "organization", "performance", "compute_task_output_asset"] | None: ...
