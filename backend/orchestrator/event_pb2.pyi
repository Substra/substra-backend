...
class Event(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        compute_task_output_asset: typing.Optional[computetask_pb2.ComputeTaskOutputAsset] = ...,
        metadata: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["algo",b"algo","asset",b"asset","compute_plan",b"compute_plan","compute_task",b"compute_task","compute_task_output_asset",b"compute_task_output_asset","data_manager",b"data_manager","data_sample",b"data_sample","failure_report",b"failure_report","model",b"model","organization",b"organization","performance",b"performance","timestamp",b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["algo",b"algo","asset",b"asset","asset_key",b"asset_key","asset_kind",b"asset_kind","channel",b"channel","compute_plan",b"compute_plan","compute_task",b"compute_task","compute_task_output_asset",b"compute_task_output_asset","data_manager",b"data_manager","data_sample",b"data_sample","event_kind",b"event_kind","failure_report",b"failure_report","id",b"id","metadata",b"metadata","model",b"model","organization",b"organization","performance",b"performance","timestamp",b"timestamp"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["asset",b"asset"]) -> typing.Optional[typing_extensions.Literal["algo","compute_plan","compute_task","data_manager","data_sample","failure_report","model","organization","performance","compute_task_output_asset"]]: ...
