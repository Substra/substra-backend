...
from organization.authentication import OrganizationBackend
...
class IncomingOrganizationTests(TestCase):
    def assert_previous_hasher_upgrade(self, previous_hasher_class: Type[BasePasswordHasher]):
        ...
        with self.modify_settings(PASSWORD_HASHERS={
        ...
        # Set our hasher as last so we can still valdiate our password but incoming_organization.check_password will upgrade to default
        with self.modify_settings(PASSWORD_HASHERS={
