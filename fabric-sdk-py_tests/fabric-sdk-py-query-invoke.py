...
try:
    ...
    response = cli.chaincode_invoke(
        ...
        peer_names=['peer1-owkin'],
        args=['ISIC 2018',
              'ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98',
              'http://chunantes.substrabac:8001/media/datasets/ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/opener.py',
              'Images',
              'ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98',
              'http://chunantes.substrabac:8001/media/datasets/ddc213a29d62eeba65c431c8641662f73b859b0f566657f9f35a4955bf298f98/description.md',
              '',
              'all'
              ],
        cc_name='mycc',
